        ...
        return (
            ...
            <div key={this.props.index} className='vertical' >
                ...
                <div className="app-img">
                    <img className={(this.props.index + 1) % 2 === 0 ? "even" : "odd"} src={this.props.artworkUrl100} alt={this.props.trackName} />
                </div>
                <div className="app-info">
                    ...
                    <div className="app-rating">
                        ...
                        />
                        <div className='count'>{this.props.userRatingCount ? `(${this.props.userRatingCount})` : `(0)`}</div>
                    </div>
                </div>
            </div>
        )
